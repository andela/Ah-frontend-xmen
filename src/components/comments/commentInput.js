      ...
      <div className="input-group">
        <div className="input-group-prepend">
          <span className="input-group-text">
            <img
              src={!props.AuthUserImage ? 'https://res.cloudinary.com/soultech/image/upload/v1550685426/authors%20haven%20pics/avatar.png' : props.AuthUserImage}
              width="60"
              alt="Profile Avatar"
              title={props.user}
              className="img-fluid comment-img rounded-circle float-left mr-3 shadow avatar"
            />
          </span>
